    ...
    <section className="bg-brand-bg pt-20 pb-20 min-h-screen">
      <div className="max-w-lg mx-auto px-4">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 md:p-10 text-center">
          ...
          <a href={`${import.meta.env.VITE_API_URL || 'http://localhost:5050'}/downloads/Financials-Studio-Setup.exe`} className="w-full flex items-center justify-center gap-3 bg-brand-navy text-white py-3.5 rounded-lg text-sm font-semibold hover:bg-brand-blue transition-colors mb-3">
